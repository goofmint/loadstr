...
class User < ActiveRecord::Base
  ...
  PRIVATE_FIELDS = ["id", "created_at", "updated_at", "activated_at", "activation_code", "crypted_password", "deleted_at", "identity_url", "login", "password_reset_code", "remember_token", "remember_token_expires_at", "salt", "state", "twitter_auth", "twitter_login"]
  
  def public_attributes
    self.attribute_names.select{|a| !User::PRIVATE_FIELDS.include?(a)}
  end
